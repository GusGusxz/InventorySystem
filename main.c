...
void ownerMenu(void) {
    ...
    while(1) {
        ...
        printf("6. View Sales\n");
        printf("7. Stock Management\n");
        printf("8. Manage Promotion\n");
        printf("9. Automated Product Import\n");
        ...
        switch(choice) {
            ...
            case 7:{
                int stockChoice;
                printf("\n=== Stock Management ===\n");
                printf("1. Manual Restock\n");
                printf("2. Hybrid Restock\n");
                printf("3. View Restock History\n");
